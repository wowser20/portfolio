                ...
                <div className="flex items-start px-4">
                  <div className="w-full">
                    ...
                    <div className="avatar w-full h-full">
                      <div className="w-24 h-24 mask mask-squere mx-auto">
                        {skeleton({
                          widthCls: 'w-full',
                          heightCls: 'h-full',
                          shape: '',
            ...
            <div className="w-full">
              <div className="px-4">
                <div className="text-center w-full">
                  <h2 className="font-medium text-center text-2xl opacity-60 mb-2">
                    {item.title}
                  </h2>
                  {item.imageUrl && (
                    <div className="avatar opacity-90">
                      <div className="w-40 h-40 mask rounded-md overflow-hidden">
                        <LazyImage
                          src={item.imageUrl}
                          alt={'thumbnail'}
